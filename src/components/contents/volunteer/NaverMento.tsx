...
const NaverMento = () => {
  return (
    <Styled.ExperienceCard>
      ...
      <Styled.ExperienceCardTitle id="네이버활동">[네이버] 스쿨혁명 대학생 멘토 SW봉사</Styled.ExperienceCardTitle>
      <Styled.ExperienceCardPeriod>2023.01.11 ~ 03.10</Styled.ExperienceCardPeriod>
      <Styled.ExperienceCardExplainContainer>
        <Explain>서울 용마초등학교 </Explain>
        <Explain>
