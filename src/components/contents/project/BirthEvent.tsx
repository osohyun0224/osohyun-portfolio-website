  ...
  return (
    <Styled.ExperienceCard>
      ...
      <Styled.ExperienceCardExplainContainer>
        <Explain>5시간 동안 개발한 챌린지 생일 이벤트 웹사이트</Explain>
        <Explain>개발 후기 회고 블로그 글, 2023.08 2주차 조회수 5위 달성 🏆</Explain>
        <Explain>Next.js와 Typescript, Firebase를 사용하여 개발을 진행함</Explain>
